...
function CardsPost(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        apiRequest("http://52.77.235.98/myposts", "POST", body,"multipart/form-data")
        .then ((res) => {
                    ...
                    <textarea className="font-pt-sans px-0 w-full text-sm text-text-color bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white
                     ...
                     <div className="flex justify-between items-center py-2 px-3 border-t dark:border-gray-600">
                        <div className="flex pl-0 space-x-1 sm:pl-2">
                            <button onClick={handleClick} type="button" className="inline-flex justify-center p-2 text-bg-color2 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                            ...
                            <input type="file" ref={hiddenFileInput} onChange={handleChange} className="hidden" name="images"/>
