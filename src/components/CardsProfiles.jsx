...
function CardsProfiles() {
  return (
    <>
    <div className="w-full max-w-sm bg-bg-color rounder-lg border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <div className="flex justify-center px-4 pt-4">
          <div className="flex flex-col items-center pb-10">
            ...
            <div className="border-y-2 border-bg-dark my-4 flex flex-wrap">
            ...
            <div className="flex flex-wrap">
              <div className="my-4 px-8 w-20"><Friendslist/></div>
              <div className="my-4 px-8 w-20"><Friendslist/></div>
              <div className="my-4 px-8 w-20"><Friendslist/></div>
              <div className="my-4 px-8 w-20"><Friendslist/></div>
              <div className="my-4 px-8 w-20"><Friendslist/></div>
