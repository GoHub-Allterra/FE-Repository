    ...
    render() {
        return (
            <nav className="w-full bg-bg-color2 sticky top-0 z-20">
                ...
                <h1 className="text-white font-pt-sans text-5xl whitespace-nowrap mr-10 ml-10">YOUR STORY</h1>
                ...
                <BsSun className='read-post-card-sendIcon flex items-end h-8 w-8 ml-10 mr-10 place-self-center text-white'/>
                </div>
            </nav >
        )
    }
